...
VALUES (1, 'johnydoe', 'John Doe', 'john@example.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', '123 Main St', 'Anytown', 'USA', '12345');
-- password123
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (2, 'janesmith', 'Jane Smith', 'jane@example.com', 'c6ba91b90d922e159893f46c387e5dc1b3dc5c101a5a4522f03b987177a24a91', '456 Elm St', 'Othertown', 'USA', '67890');
-- password456
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (3, 'mick_jonh', 'Michael Johnson', 'michael@example.com', '5efc2b017da4f7736d192a74dde5891369e0685d4d38f2a455b6fcdab282df9c', '789 Oak St', 'Another Town', 'USA', '45678');
-- password789
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (4, 'embrown', 'Emily Brown', 'emily@example.com', '963c8b37b3615f3c7f88cbb0f6becff1ffe726f4', '101 Pine St', 'Someplace', 'USA', '89012');
-- passwordabc
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (5, 'janedoe', 'Jane Doe', 'jane.doe@example.com', 'cb7136bb81e63b9dd98c4736bade626b6685d3a6a22129075416dd88afaf075d', '456 Oak St', 'Sometown', 'USA', '54321');
-- olaadeus23
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (6, 'markjohnson', 'Mark Johnson', 'mark.johnson@example.com', '71154ca37013e686b818dad0a16c584c8253d4ed892068cad81c5e9642e0c0c4', '789 Maple St', 'Anothertown', 'USA', '67890');
-- soufixe09
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (7, 'emilywilson', 'Emily Wilson', 'emily.wilson@example.com', '55729422f621f9d6fef830924ea4c74f3db4f3aac1017d4e98a8011fd5304130', '101 Pine St', 'Yetanothertown', 'USA', '12345');
-- adeus5ola0
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (8, 'alexsmith', 'Alex Smith', 'alex.smith@example.com', 'bd09f7ad06c6ca58501394524cdddf77f50dbcc28df10f67fc7f06af329abf8b', '123 Elm St', 'Othertown', 'USA', '89012');
-- girafas_bonitas5
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (9, 'sarahbrown', 'Sarah Brown', 'sarah.brown@example.com', 'd0430590a251acc9ed7744831a7a8a51705689cff6ba141f8bf82a15d9f5b415', '321 Cedar St', 'Somewhere', 'USA', '45678');
-- naogosto8gelado
INSERT INTO User (UserId, Username, Name_, Email, Password_, Adress, City, Country, PostalCode)
VALUES (10, 'michaeljones', 'Michael Jones', 'michael.jones@example.com', '1f4b817f73ca25b782ee67c5822f6ebcbd62c76b90bc3b5448bb17f0632f56db', '567 Pineapple St', 'Anywhere', 'USA', '13579');
-- pretoebranc0
...
VALUES (101, 'Sapphire Bracelet', 29, 'Blue Jewelers', 'SB2024', 'New', 'Beads and bracelets', 1, NULL, 7);
INSERT INTO Item (ItemId, Name_, Price, Brand, Model, Condition, Category, Stock, Image_, Size_)
